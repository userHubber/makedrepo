...
public class Case_Negative extends DriverMethods {
...
//========================================================================================
    ...
    public void preconditions() {
        System.out.println("АВТОРИЗАЦИЯ, НЕГАТИВНЫЙ СЦЕНАРИЙ");
    ...
    public void case_loginPositive() {
        step.writeLoginFormIncorrectPass(user_info.REGISTRATEDMAIL, user_info.variantsPassForNegativeLogin);
    }
